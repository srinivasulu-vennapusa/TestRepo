...
#include <zxing/ImageProcessing.h>
...
//      Ref<LuminanceSource> filteredSource = getLuminanceSource();
//      if (filteredSource->getWidth() >= MINIMUM_DIMENSION && source->getHeight() >= MINIMUM_DIMENSION) {
//          unsigned char* luminances = filteredSource->getMatrix123();
//          
//          int width = filteredSource->getWidth();
//          int height = filteredSource->getHeight();
//          
...
//          
//          matrix_.reset(new BitMatrix(width,height));
//          calculateThresholdForBlock(luminances, subWidth, subHeight, width, height, blackPoints, matrix_);
//          delete [] blackPoints;
//          delete [] luminances;
//      }
}

void HybridBinarizer::calculateThresholdForBlock(unsigned char* luminances,
                                           int subWidth,
                                           int subHeight,
                                           int width,
                                           int height,
