...
#include <Histogram.h>
#include <VIN/IllegalArgumentException.h>
#include <VIN/Array.h>
#include <math.h>
...
namespace VIN {
    ...
    Histogram::Histogram(Ref<GreyscaleLuminanceSource> source) :
    ...
    Ref<BitArray> Histogram::getBlackRow(int y, Ref<BitArray> row) {
        ...
        GreyscaleLuminanceSource& source = *getLuminanceSource();
    ...
    Ref<Binarizer> Histogram::createBinarizer(Ref<GreyscaleLuminanceSource> source) {
