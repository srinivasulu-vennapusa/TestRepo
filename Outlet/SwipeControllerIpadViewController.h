//
//  SwipeControllerIpadViewController.h
//  OmniRetailer
//
//  Created by Chandrasekhar on 10/30/14.
//
//
...
@interface SwipeControllerIpadViewController : UIViewController<UITextFieldDelegate>{
