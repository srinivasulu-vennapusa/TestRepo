...
@interface stockRequest : CustomNavigationController<MBProgressHUDDelegate,UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,StockRequestDelegate,ZoneMasterDelegate,utilityMasterServiceDelegate,OutletMasterDelegate,ModelMasterDelegate,RolesServiceDelegate,SkuServiceDelegate>
{
