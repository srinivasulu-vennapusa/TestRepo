...
- (void)badgeInit
{
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        self.badgeOriginX   = (self.frame.size.width - self.badge.frame.size.width/2) + 120;
        self.badgeOriginY   = 10;

    }
    else {
        self.badgeOriginX   = (self.frame.size.width - self.badge.frame.size.width/2) + 110;
        self.badgeOriginY   = 10;
...
//    if (!badgeValue || [badgeValue isEqualToString:@""] || ([badgeValue isEqualToString:@"0"] && self.shouldHideBadgeAtZero)) {
    ...
    if (!badgeValue || [badgeValue isEqualToString:@""] || ((badgeValue.length == 0) && self.shouldHideBadgeAtZero)) {
