 ...
 * @param
 * @return
 * @modified BY  Roja on 24-09-2018...
 * @reason       Changing UI part as per latest updates. * @verified By
 * @verified On
 */
...
//    orderIdLabel.backgroundColor = [UIColor blackColor];
...
//    orderIdValueLabel.backgroundColor = [UIColor blackColor];
...
//    shippingCostText.userInteractionEnabled  = NO;
...
//
//    submitButton2.hidden = YES;
//    saveButton2.hidden = YES;
//
...
//    // ScrollView...
//
//    buttonScrollView  = [[UIScrollView alloc]init];
//    //buttonScrollView.backgroundColor = [UIColor lightGrayColor];
//
//    //setting the titleName for the Page....
//    self.titleLabel.text = NSLocalizedString(@"omni_retailer", nil);
//
//    headerNameLabel.text = NSLocalizedString(@"edit_order", nil);
//
...
//
//
//        orderIdLabel.frame = CGRectMake(10,10,90,40);
//
//        orderIdValueLabel.frame = CGRectMake(orderIdLabel.frame.origin.x + orderIdLabel.frame.size.width + 5, orderIdLabel.frame.origin.y, 280,40);
//
//        buttonScrollView.frame = CGRectMake(((createOrderScrollView.frame.size.width)/2) + 50, 5, 455, 45);
//
//        separationLabel.frame = CGRectMake(headerNameLabel.frame.origin.x,buttonScrollView.frame.origin.y + buttonScrollView.frame.size.height + 5,headerNameLabel.frame.size.width,0.5);
//
//        float labelHeight  = 30;
//        float horizontaGap = 154;
//
//        //Row1
//        orderDateLabel.frame  = CGRectMake(orderIdLabel.frame.origin.x, separationLabel.frame.origin.y + separationLabel.frame.size.height + 10 , 120, labelHeight);
...
//
//        searchItemsText.frame = CGRectMake(orderDateLabel.frame.origin.x, otherDiscPercentageTxt.frame.origin.y + otherDiscPercentageTxt.frame.size.height + 50,buttonScrollView.frame.origin.x + buttonScrollView.frame.size.width - (orderDateLabel.frame.origin.x),40);
//
...
//        orderItemsScrollView.contentSize = CGSizeMake( (snoLabel.frame.origin.x + actionLabel.frame.origin.x + actionLabel.frame.size.width + 15), orderItemsScrollView.frame.size.height);
//
...
//        subTotalLabel.frame = CGRectMake(buttonScrollView.frame.origin.x + 65,orderItemsScrollView.frame.origin.y + orderItemsScrollView.frame.size.height + 20, 80,30);
...
//
//        backButton2.frame = CGRectMake(searchItemsText.frame.origin.x, (orderTotalsView.frame.origin.y + orderTotalsView.frame.size.height - 40),115,40);
//
...
//
//    [createOrderScrollView addSubview:orderIdLabel];
//    [createOrderScrollView addSubview:orderIdValueLabel];
//
//    [createOrderScrollView addSubview:buttonScrollView];
//
...
//
//
//    orderIdLabel.font = [UIFont fontWithName:TEXT_FONT_NAME size:20.0f];
//    orderIdValueLabel.font = [UIFont fontWithName:TEXT_FONT_NAME size:20.f];
//
...
- (void)viewDidLoad {
    ...
    UILabel * lastNameLbl;
    UILabel * deliveryStartTimeLbl;
    UILabel * deliveryEndTimeLbl;
    UILabel * confirmStartTimeLbl;
    UILabel * confirmStartTimeStarLbl;
    UILabel * confirmEndTimeLbl;
    UILabel * confirmEndTimeStarLbl;
    ...
    UILabel * orderDateStarLabel;
    UILabel * deliveryDateLabel;
    UILabel * confirmDateLabel;
    UILabel * deliveryDateStarLabel;
    UILabel * confirmDateStarLabel;
    UILabel * paymentModeLabel;
    UILabel * paymentTypeLabel;
    ...
    deliveryStartTimeLbl = [[UILabel alloc] init];
    deliveryStartTimeLbl.layer.cornerRadius = 5.0f;
    deliveryStartTimeLbl.layer.masksToBounds = YES;
    deliveryStartTimeLbl.numberOfLines = 1;
    deliveryStartTimeLbl.textAlignment = NSTextAlignmentLeft;
    deliveryStartTimeLbl.backgroundColor = [UIColor blackColor];
    deliveryStartTimeLbl.textColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];
    
    deliveryEndTimeLbl = [[UILabel alloc] init];
    deliveryEndTimeLbl.layer.cornerRadius = 5.0f;
    deliveryEndTimeLbl.layer.masksToBounds = YES;
    deliveryEndTimeLbl.numberOfLines = 1;
    deliveryEndTimeLbl.textAlignment = NSTextAlignmentLeft;
    deliveryEndTimeLbl.backgroundColor = [UIColor blackColor];
    deliveryEndTimeLbl.textColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];
    
    confirmStartTimeLbl = [[UILabel alloc] init];
    confirmStartTimeLbl.layer.cornerRadius = 5.0f;
    confirmStartTimeLbl.layer.masksToBounds = YES;
    confirmStartTimeLbl.numberOfLines = 1;
    confirmStartTimeLbl.textAlignment = NSTextAlignmentLeft;
    confirmStartTimeLbl.backgroundColor = [UIColor blackColor];
    confirmStartTimeLbl.textColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];

    confirmStartTimeStarLbl = [[UILabel alloc] init];
    confirmStartTimeStarLbl.textAlignment = NSTextAlignmentLeft;
    confirmStartTimeStarLbl.backgroundColor = [UIColor blackColor];
    confirmStartTimeStarLbl.textColor = [[UIColor redColor]colorWithAlphaComponent:0.7];
    confirmStartTimeStarLbl.font = [UIFont systemFontOfSize:30];

    confirmEndTimeLbl = [[UILabel alloc] init];
    confirmEndTimeLbl.layer.cornerRadius = 5.0f;
    confirmEndTimeLbl.layer.masksToBounds = YES;
    confirmEndTimeLbl.numberOfLines = 1;
    confirmEndTimeLbl.textAlignment = NSTextAlignmentLeft;
    confirmEndTimeLbl.backgroundColor = [UIColor blackColor];
    confirmEndTimeLbl.textColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];

    confirmEndTimeStarLbl = [[UILabel alloc] init];
    confirmEndTimeStarLbl.textAlignment = NSTextAlignmentLeft;
    confirmEndTimeStarLbl.backgroundColor = [UIColor blackColor];
    confirmEndTimeStarLbl.textColor = [[UIColor redColor]colorWithAlphaComponent:0.7];
    confirmEndTimeStarLbl.font = [UIFont systemFontOfSize:30];
    ...
    confirmDateLabel = [[UILabel alloc] init];
    confirmDateLabel.layer.cornerRadius = 5.0f;
    confirmDateLabel.layer.masksToBounds = YES;
    confirmDateLabel.numberOfLines = 1;
    confirmDateLabel.textAlignment = NSTextAlignmentLeft;
    confirmDateLabel.backgroundColor = [UIColor blackColor];
    confirmDateLabel.textColor = [[UIColor whiteColor]colorWithAlphaComponent:0.7];
    ...
    confirmDateStarLabel = [[UILabel alloc] init];
    confirmDateStarLabel.textAlignment = NSTextAlignmentLeft;
    confirmDateStarLabel.backgroundColor = [UIColor blackColor];
    confirmDateStarLabel.textColor = [[UIColor redColor]colorWithAlphaComponent:0.7];
    confirmDateStarLabel.font = [UIFont systemFontOfSize:30];
    ...
    deliveryStartTimeTF = [[CustomTextField alloc] init];
    deliveryStartTimeTF.delegate = self;
    deliveryStartTimeTF.userInteractionEnabled  = NO;
    deliveryStartTimeTF.text = @"";
    deliveryStartTimeTF.placeholder = @"Start Time";
    deliveryStartTimeTF.borderStyle = UITextBorderStyleRoundedRect;
    
    deliveryEndTimeTF = [[CustomTextField alloc] init];
    deliveryEndTimeTF.delegate = self;
    deliveryEndTimeTF.userInteractionEnabled  = NO;
    deliveryEndTimeTF.text = @"";
    deliveryEndTimeTF.placeholder = @"End Name";
    deliveryEndTimeTF.borderStyle = UITextBorderStyleRoundedRect;

    confirmStartTimeTF = [[CustomTextField alloc] init];
    confirmStartTimeTF.delegate = self;
    confirmStartTimeTF.userInteractionEnabled  = YES;
    confirmStartTimeTF.text = @"";
    confirmStartTimeTF.placeholder = @"Start Time";
    confirmStartTimeTF.borderStyle = UITextBorderStyleRoundedRect;

    confirmEndTimeTF = [[CustomTextField alloc] init];
    confirmEndTimeTF.delegate = self;
    confirmEndTimeTF.userInteractionEnabled  = YES;
    confirmEndTimeTF.text = @"";
    confirmEndTimeTF.placeholder = @"End Name";
    confirmEndTimeTF.borderStyle = UITextBorderStyleRoundedRect;
    ...
    confirmDateText = [[CustomTextField alloc] init];
    confirmDateText.delegate = self;
    confirmDateText.userInteractionEnabled  = NO;
    confirmDateText.placeholder = @"Confirm Date";
    confirmDateText.borderStyle = UITextBorderStyleRoundedRect;
    ...
    paymentModeText.text = @"On Delivery"; // setting default
    ...
    paymentTypeText.text = @"Debit";// setting default
    ...
    UIButton * confirmStartTimeBtn;
    UIButton * confirmEndTimeBtn;
    ...
    confirmDateButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [confirmDateButton setBackgroundImage:calendarIconImage forState:UIControlStateNormal];
    ...
    confirmStartTimeBtn = [UIButton buttonWithType:UIButtonTypeCustom];
//    [confirmStartTimeBtn setBackgroundImage:calendarIconImage forState:UIControlStateNormal];
    [confirmStartTimeBtn setBackgroundImage:[UIImage imageNamed:@"down_gray_arrow"] forState:UIControlStateNormal];

    confirmEndTimeBtn = [UIButton buttonWithType:UIButtonTypeCustom];
//    [confirmEndTimeBtn setBackgroundImage:calendarIconImage forState:UIControlStateNormal];
    [confirmEndTimeBtn setBackgroundImage:[UIImage imageNamed:@"down_gray_arrow"] forState:UIControlStateNormal];
    
    
    [orderDateButton addTarget:self action:@selector(showCalenderInPopUp:) forControlEvents:UIControlEventTouchDown];
    [deliveryDateButton addTarget:self action:@selector(showCalenderInPopUp:) forControlEvents:UIControlEventTouchDown];
    [confirmDateButton addTarget:self action:@selector(showCalenderInPopUp:) forControlEvents:UIControlEventTouchDown];
    [paymentModeButton addTarget:self action:@selector(showPaymentMode:) forControlEvents:UIControlEventTouchDown];
    [paymentTypeButton addTarget:self action:@selector(showPaymentType:) forControlEvents:UIControlEventTouchDown];
    [confirmStartTimeBtn addTarget:self action:@selector(showStartTime:) forControlEvents:UIControlEventTouchDown];
    ...
    customerMobileNoText = [[CustomTextField alloc] init];
    customerMobileNoText.delegate = self;
    customerMobileNoText.userInteractionEnabled  = NO;
    customerMobileNoText.keyboardType = UIKeyboardTypeNumberPad;
    customerMobileNoText.clearButtonMode = UITextFieldViewModeWhileEditing;
    customerMobileNoText.placeholder = NSLocalizedString(@"enter_contact_no", nil);
    ...
    availableQtyLbl = [[CustomLabel alloc]init];
    [availableQtyLbl awakeFromNib];
    
    confirmQtyLbl = [[CustomLabel alloc]init];
    [confirmQtyLbl awakeFromNib];
    // upto here added by roja on 10-09-2018.. && 16/04/2019
    ...
    [submitBtn addTarget:self action:@selector(updateOrder:) forControlEvents:UIControlEventTouchDown];

    saveBtn = [[UIButton alloc] init];
    saveBtn.layer.cornerRadius = 3.0f;
    saveBtn.backgroundColor = [UIColor grayColor];
    [saveBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [saveBtn addTarget:self action:@selector(updateOrder:) forControlEvents:UIControlEventTouchDown];
    ...
    [cancelBtn addTarget:self action:@selector(backAction) forControlEvents:UIControlEventTouchDown];
...
#pragma mark UITableView..
    ...
    startTimeTable = [[UITableView alloc]init];
    buttonScrollView  = [[UIScrollView alloc]init];
    ...
    deliveryStartTimeLbl.text = NSLocalizedString(@"Start Time", nil);//time_slot
    deliveryEndTimeLbl.text = NSLocalizedString(@"End Time", nil);

    confirmStartTimeLbl.text = NSLocalizedString(@"Start Time", nil);//time_slot
    confirmStartTimeStarLbl.text = NSLocalizedString(@"*", nil);
    confirmEndTimeLbl.text = NSLocalizedString(@"End Time", nil);
    confirmEndTimeStarLbl.text = NSLocalizedString(@"*", nil);
    ...
    orderDateStarLabel.text = NSLocalizedString(@"*", nil);
    deliveryDateLabel.text = NSLocalizedString(@"delivery_Date", nil);
    confirmDateLabel.text = NSLocalizedString(@"Confirm Date", nil);
    deliveryDateStarLabel.text = NSLocalizedString(@"*", nil);
    confirmDateStarLabel.text = NSLocalizedString(@"*", nil);
    paymentModeLabel.text = NSLocalizedString(@"payment_mode", nil);
    paymentTypeLabel.text = NSLocalizedString(@"payment_type", nil);
    locationLabel.text = NSLocalizedString(@"location",nil);
    customerEmailIdLabel.text = NSLocalizedString(@"customer_email_id",nil);
...
//    discountLbl.text = NSLocalizedString(@"discount", "");
    ...
    actionLabel.text = NSLocalizedString(@"action",nil);
    availableQtyLbl.text = NSLocalizedString(@"avail Qty",nil);
    confirmQtyLbl.text = NSLocalizedString(@"cnfm Qty",nil);
    ...
    customerMobileNoText.backgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];
    orderDateText.backgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];
    confirmStartTimeTF.backgroundColor = [UIColor whiteColor];
    confirmEndTimeTF.backgroundColor = [UIColor whiteColor];
    paymentTypeText.backgroundColor = [UIColor whiteColor];
    deliveryStartTimeTF.backgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];
    deliveryEndTimeTF.backgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];

    lastNameTF.backgroundColor = [UIColor whiteColor];
    customerEmailIdText.backgroundColor = [UIColor whiteColor];
    deliveryDateText.backgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];
    confirmDateText.backgroundColor = [UIColor whiteColor];
    locationText.backgroundColor = [UIColor whiteColor];
    deliveryModelTF.backgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];
...
//        firstNameLbl.backgroundColor = [UIColor blueColor];
//        customerMobileNoLabel.backgroundColor = [UIColor blueColor];
//        orderDateLabel.backgroundColor = [UIColor blueColor];
//        confirmStartTimeLbl.backgroundColor = [UIColor blueColor];
//        confirmEndTimeLbl.backgroundColor = [UIColor blueColor];
//        paymentTypeLabel.backgroundColor = [UIColor blueColor];
//        lastNameLbl.backgroundColor = [UIColor blueColor];
//        customerEmailIdLabel.backgroundColor = [UIColor blueColor];
//        deliveryDateLabel.backgroundColor = [UIColor blueColor];
//        confirmDateLabel.backgroundColor = [UIColor blueColor];
//        locationLabel.backgroundColor = [UIColor blueColor];
//        deliveryModelLbl.backgroundColor = [UIColor blueColor];
//        paymentModeLabel.backgroundColor = [UIColor blueColor];


        firstNameLbl.frame = CGRectMake(orderIdLabel.frame.origin.x, separationLabel.frame.origin.y + separationLabel.frame.size.height + 10, 120, labelHeight);
        firstNameTF.frame = CGRectMake(firstNameLbl.frame.origin.x, firstNameLbl.frame.origin.y + firstNameLbl.frame.size.height, 120, 40);
        
        customerMobileNoLabel.frame = CGRectMake(firstNameTF.frame.origin.x + firstNameTF.frame.size.width + labelToLabelWidth, firstNameLbl.frame.origin.y, 90, labelHeight);
        customerMobileNoStarLabel.frame = CGRectMake(customerMobileNoLabel.frame.origin.x + customerMobileNoLabel.frame.size.width , customerMobileNoLabel.frame.origin.y, 10, labelHeight);
        customerMobileNoText.frame = CGRectMake(customerMobileNoLabel.frame.origin.x, firstNameTF.frame.origin.y, 150, firstNameTF.frame.size.height);
        ...
        orderDateText.frame = CGRectMake(orderDateLabel.frame.origin.x, firstNameTF.frame.origin.y, 150, firstNameTF.frame.size.height);
        orderDateButton.frame = CGRectMake ((orderDateText.frame.origin.x + orderDateText.frame.size.width - 45), orderDateText.frame.origin.y + 2, 40, 35);
        
        deliveryDateLabel.frame = CGRectMake(orderDateText.frame.origin.x + orderDateText.frame.size.width + labelToLabelWidth, firstNameLbl.frame.origin.y, 120, labelHeight);
        ...
        deliveryDateText.frame = CGRectMake(deliveryDateLabel.frame.origin.x, firstNameTF.frame.origin.y, 180, firstNameTF.frame.size.height);
        deliveryDateButton.frame = CGRectMake ((deliveryDateText.frame.origin.x + deliveryDateText.frame.size.width - 45), deliveryDateText.frame.origin.y + 2, 40, 35);

        confirmDateLabel.frame = CGRectMake(deliveryDateText.frame.origin.x + deliveryDateText.frame.size.width + labelToLabelWidth, firstNameLbl.frame.origin.y, 120, labelHeight);
        confirmDateStarLabel.frame  = CGRectMake((confirmDateLabel.frame.origin.x + confirmDateLabel.frame.size.width)-15, confirmDateLabel.frame.origin.y, 10, labelHeight);
        confirmDateText.frame = CGRectMake(confirmDateLabel.frame.origin.x, firstNameTF.frame.origin.y, 180, firstNameTF.frame.size.height);
        confirmDateButton.frame = CGRectMake ((confirmDateText.frame.origin.x + confirmDateText.frame.size.width - 45), confirmDateText.frame.origin.y + 2, 40, 35);
        
        paymentTypeLabel.frame  = CGRectMake(confirmDateText.frame.origin.x + confirmDateText.frame.size.width + labelToLabelWidth, firstNameLbl.frame.origin.y, 120, labelHeight);
        paymentTypeText.frame   = CGRectMake(paymentTypeLabel.frame.origin.x, firstNameTF.frame.origin.y, 130, firstNameTF.frame.size.height);
        paymentTypeButton.frame = CGRectMake ((paymentTypeText.frame.origin.x + paymentTypeText.frame.size.width - 30), paymentTypeText.frame.origin.y + 12, 20, (paymentTypeText.frame.size.height-24));
        ...
        customerEmailIdLabel.frame = CGRectMake(customerMobileNoLabel.frame.origin.x, lastNameLbl.frame.origin.y, 150, labelHeight);
        customerEmailIdText.frame = CGRectMake(customerEmailIdLabel.frame.origin.x, lastNameTF.frame.origin.y, customerMobileNoText.frame.size.width, firstNameTF.frame.size.height);
        
        deliveryModelLbl.frame = CGRectMake(orderDateLabel.frame.origin.x, lastNameLbl.frame.origin.y, 120, labelHeight);
        deliveryModelTF.frame = CGRectMake(deliveryModelLbl.frame.origin.x, lastNameTF.frame.origin.y, orderDateText.frame.size.width, firstNameTF.frame.size.height);
        deliveryMdlDropDownBtn.frame = CGRectMake ((deliveryModelTF.frame.origin.x + deliveryModelTF.frame.size.width - 30), deliveryModelTF.frame.origin.y + 12, 20, (deliveryModelTF.frame.size.height - 24));//60
        
        deliveryStartTimeLbl.frame  = CGRectMake(deliveryDateText.frame.origin.x, lastNameLbl.frame.origin.y, 87, labelHeight);
        deliveryStartTimeTF.frame = CGRectMake(deliveryStartTimeLbl.frame.origin.x, lastNameTF.frame.origin.y, 87, firstNameTF.frame.size.height);

        deliveryEndTimeLbl.frame  = CGRectMake(deliveryStartTimeTF.frame.origin.x + deliveryStartTimeTF.frame.size.width + 6, lastNameLbl.frame.origin.y, 87, labelHeight);
        deliveryEndTimeTF.frame  = CGRectMake(deliveryEndTimeLbl.frame.origin.x, lastNameTF.frame.origin.y, 87, lastNameTF.frame.size.height);
        
        confirmStartTimeLbl.frame  = CGRectMake(confirmDateText.frame.origin.x, lastNameLbl.frame.origin.y, 87, labelHeight);
        confirmStartTimeTF.frame = CGRectMake(confirmStartTimeLbl.frame.origin.x, lastNameTF.frame.origin.y, 87, firstNameTF.frame.size.height);
        confirmStartTimeBtn.frame = CGRectMake ((confirmStartTimeTF.frame.origin.x + confirmStartTimeTF.frame.size.width - 25), confirmStartTimeTF.frame.origin.y + 12, 20, (confirmStartTimeTF.frame.size.height-24));
        confirmStartTimeStarLbl.frame = CGRectMake(confirmStartTimeLbl.frame.origin.x + confirmStartTimeLbl.frame.size.width-5, confirmStartTimeLbl.frame.origin.y, 10, labelHeight);
        
        confirmEndTimeLbl.frame  = CGRectMake(confirmStartTimeTF.frame.origin.x + confirmStartTimeTF.frame.size.width + 6, lastNameLbl.frame.origin.y, 87, labelHeight);
        confirmEndTimeTF.frame  = CGRectMake(confirmEndTimeLbl.frame.origin.x, lastNameTF.frame.origin.y, 87, firstNameTF.frame.size.height);
        confirmEndTimeBtn.frame = CGRectMake ((confirmEndTimeTF.frame.origin.x + confirmEndTimeTF.frame.size.width - 25), confirmEndTimeTF.frame.origin.y + 12, 20, (confirmEndTimeTF.frame.size.height-24));
        confirmEndTimeStarLbl.frame = CGRectMake(confirmEndTimeLbl.frame.origin.x + confirmEndTimeLbl.frame.size.width - 10, confirmEndTimeLbl.frame.origin.y, 10, labelHeight);
        
        paymentModeLabel.frame = CGRectMake(paymentTypeLabel.frame.origin.x, lastNameLbl.frame.origin.y , 120, labelHeight);
        paymentModeText.frame = CGRectMake(paymentModeLabel.frame.origin.x, lastNameTF.frame.origin.y, 130, firstNameTF.frame.size.height);
        paymentModeButton.frame = CGRectMake ((paymentModeText.frame.origin.x + paymentModeText.frame.size.width - 30), paymentModeText.frame.origin.y + 12, 20, (paymentModeText.frame.size.height-24));//60
        ...
        orderChannelButton.frame = CGRectMake((orderChannelText.frame.origin.x + orderChannelText.frame.size.width - 30), orderChannelText.frame.origin.y + 12, 20, (orderChannelText.frame.size.height - 24));
        ...
        shipmentTypeButton.frame = CGRectMake ((shipmentTypeText.frame.origin.x + shipmentTypeText.frame.size.width - 30), shipmentTypeText.frame.origin.y + 12, 20, (shipmentTypeText.frame.size.height - 24));
        ...
        deliveryTypeButton.frame = CGRectMake ((deliveryTypeText.frame.origin.x + deliveryTypeText.frame.size.width - 30), deliveryTypeText.frame.origin.y + 12, 20, (deliveryTypeText.frame.size.height - 24));
        ...
        shipmentModeButton.frame = CGRectMake ((shipmentModeText.frame.origin.x + shipmentModeText.frame.size.width - 30), shipmentModeText.frame.origin.y + 12, 20, (deliveryModelTF.frame.size.height-24));
...
//    [createOrderScrollView addSubview:orderDateButton];
    ...
    [createOrderScrollView addSubview:deliveryStartTimeLbl];
    [createOrderScrollView addSubview:deliveryStartTimeTF];
    [createOrderScrollView addSubview:deliveryEndTimeLbl];
    [createOrderScrollView addSubview:deliveryEndTimeTF];

    [createOrderScrollView addSubview:confirmStartTimeLbl];
    [createOrderScrollView addSubview:confirmStartTimeTF];
    [createOrderScrollView addSubview:confirmStartTimeBtn];
    [createOrderScrollView addSubview:confirmStartTimeStarLbl];

    [createOrderScrollView addSubview:confirmEndTimeLbl];
    [createOrderScrollView addSubview:confirmEndTimeTF];
    [createOrderScrollView addSubview:confirmEndTimeBtn];
    [createOrderScrollView addSubview:confirmEndTimeStarLbl];
...
//    [createOrderScrollView addSubview:deliveryDateButton];
    ...
    [createOrderScrollView addSubview:confirmDateLabel];
    [createOrderScrollView addSubview:confirmDateStarLabel];
    [createOrderScrollView addSubview:confirmDateText];
    [createOrderScrollView addSubview:confirmDateButton];
...
//    [createOrderScrollView addSubview:deliveryMdlDropDownBtn];
    ...
    [orderItemsScrollView addSubview:uomLbl];
    [orderItemsScrollView addSubview:offerLbl];
    [orderItemsScrollView addSubview:availableQtyLbl];
    [orderItemsScrollView addSubview:confirmQtyLbl];
    // upto here added by roja on 10-09-2018...
    [orderItemsScrollView addSubview:actionLabel];
    ...
    [createOrderScrollView addSubview:submitBtn];
    [createOrderScrollView addSubview:saveBtn];
    [createOrderScrollView addSubview:cancelBtn];
...
/*
 ...
 confirmStartTimeLbl.frame  = CGRectMake(orderDateText.frame.origin.x + orderDateText.frame.size.width + labelToLabelWidth, firstNameLbl.frame.origin.y, 120, labelHeight);
 confirmStartTimeTF.frame = CGRectMake(confirmStartTimeLbl.frame.origin.x, firstNameTF.frame.origin.y,firstNameTF.frame.size.width, firstNameTF.frame.size.height);
 confirmStartTimeBtn.frame = CGRectMake ((confirmStartTimeTF.frame.origin.x + confirmStartTimeTF.frame.size.width - 45), confirmStartTimeTF.frame.origin.y + 2, 40, 35);
 confirmStartTimeStarLbl.frame = CGRectMake(confirmStartTimeLbl.frame.origin.x + (confirmStartTimeLbl.frame.size.width/2) + 20, customerMobileNoLabel.frame.origin.y, 10, labelHeight);
 
 confirmEndTimeLbl.frame  = CGRectMake(confirmStartTimeTF.frame.origin.x + confirmStartTimeTF.frame.size.width + labelToLabelWidth, firstNameLbl.frame.origin.y, 120, labelHeight);
 confirmEndTimeTF.frame  = CGRectMake(confirmEndTimeLbl.frame.origin.x, firstNameTF.frame.origin.y,firstNameTF.frame.size.width, firstNameTF.frame.size.height);
 confirmEndTimeBtn.frame = CGRectMake ((confirmEndTimeTF.frame.origin.x + confirmEndTimeTF.frame.size.width - 45), confirmEndTimeTF.frame.origin.y + 2, 40, 35);
 confirmEndTimeStarLbl.frame = CGRectMake(confirmEndTimeLbl.frame.origin.x + (confirmEndTimeLbl.frame.size.width/2) + 15, customerMobileNoLabel.frame.origin.y, 10, labelHeight);
 
 
 paymentTypeLabel.frame  = CGRectMake(confirmEndTimeTF.frame.origin.x + confirmEndTimeTF.frame.size.width + labelToLabelWidth, firstNameLbl.frame.origin.y, 120, labelHeight);
 ...
 paymentTypeButton.frame = CGRectMake ((paymentTypeText.frame.origin.x + paymentTypeText.frame.size.width - 20), paymentTypeText.frame.origin.y + 12, 15, (paymentTypeText.frame.size.height-24));
 ...
 locationLabel.frame = CGRectMake(confirmStartTimeLbl.frame.origin.x, lastNameLbl.frame.origin.y, 120, labelHeight);
 ...
 locationButton.frame = CGRectMake ((locationText.frame.origin.x + locationText.frame.size.width - 30), locationText.frame.origin.y + 12, 25, (locationText.frame.size.height-24));//60
 
 deliveryModelLbl.frame = CGRectMake(confirmEndTimeLbl.frame.origin.x, lastNameLbl.frame.origin.y, 120, labelHeight);
 ...
 deliveryMdlDropDownBtn.frame = CGRectMake ((deliveryModelTF.frame.origin.x + deliveryModelTF.frame.size.width - 30), deliveryModelTF.frame.origin.y + 12, 25, (deliveryModelTF.frame.size.height - 24));//60
 ...
 paymentModeButton.frame = CGRectMake ((paymentModeText.frame.origin.x + paymentModeText.frame.size.width - 20), paymentModeText.frame.origin.y + 12, 15, (paymentModeText.frame.size.height-24));//60
...
-(void)setOrderDetailsViewFrame{
    ...
    availableQtyLbl.frame = CGRectMake(mrpLabel.frame.origin.x + mrpLabel.frame.size.width + 2, snoLabel.frame.origin.y,60, snoLabel.frame.size.height);
    
    quantityLabel.frame = CGRectMake(availableQtyLbl.frame.origin.x + availableQtyLbl.frame.size.width + 2, snoLabel.frame.origin.y, 60, snoLabel.frame.size.height);
    
    confirmQtyLbl.frame = CGRectMake(quantityLabel.frame.origin.x + quantityLabel.frame.size.width + 2, snoLabel.frame.origin.y,60, snoLabel.frame.size.height);

    offerLbl.frame = CGRectMake(confirmQtyLbl.frame.origin.x + confirmQtyLbl.frame.size.width + 2, snoLabel.frame.origin.y, 85, snoLabel.frame.size.height);

    discountLbl.frame = CGRectMake(offerLbl.frame.origin.x + offerLbl.frame.size.width + 2, snoLabel.frame.origin.y, 105, snoLabel.frame.size.height);
    ...
    amountPaidLabel.frame = CGRectMake(otherDiscountsLbl.frame.origin.x, netValueLabel.frame.origin.y + netValueLabel.frame.size.height + 5, otherDiscountsLbl.frame.size.width, otherDiscountsLbl.frame.size.height);
    ...
    submitBtn.frame = CGRectMake(searchItemsText.frame.origin.x, (totalCostText.frame.origin.y), 115, 40);
    
    saveBtn.frame = CGRectMake(submitBtn.frame.origin.x + submitBtn.frame.size.width + 20, submitBtn.frame.origin.y, 115, 40);
    
    cancelBtn.frame = CGRectMake(saveBtn.frame.origin.x + saveBtn.frame.size.width + 20, submitBtn.frame.origin.y, 115, 40);

    if(saveBtn.hidden == YES){
        
        cancelBtn.frame = CGRectMake(submitBtn.frame.origin.x + submitBtn.frame.size.width + 20, submitBtn.frame.origin.y, 115, 40);
    }
...
/**
 * @description  Here we are changing the drop down btn image and hidding customer details on selection of dropDownBtn.
 * @date         12/14/2019
 * @method       customerDetailsViewDropDownBtnAction
 * @author       Roja
 * @param
 * @param
 * @return
    ...
    @try {
        ...
        if(isToCallApplyCampaigns){
            ...
            for (int i = 0; i < orderItemListArray.count; i++) {
                ...
                [qtyList addObject: [NSString stringWithFormat:@"%.2f",[[itemDetailsDic valueForKey:CONFIRM_QUANTITY]floatValue] ] ]; //ORDERED_QUANTITY
                [totalPriceList addObject: [NSString stringWithFormat:@"%.2f", [[itemDetailsDic valueForKey:Item_Price] floatValue] * [[itemDetailsDic valueForKey:CONFIRM_QUANTITY]floatValue]] ]; //ORDERED_QUANTITY
...
//
//    if ((deliveryDateText.text).length == 0) {
//
//        float y_axis = self.view.frame.size.height - 120;
//
...
//        // [deliveryDateText becomeFirstResponder];
//    }
...
//    }
//    else if ((customerEmailIdText.text).length == 0) {
//
//        float y_axis = self.view.frame.size.height - 450;
//        NSString * mesg = [NSString stringWithFormat:@"%@",NSLocalizedString(@"please_enter_email_id",nil)];
//        [self displayAlertMessage:mesg horizontialAxis:(self.view.frame.size.width - 400)/2   verticalAxis:y_axis  msgType:@""  conentWidth:300 contentHeight:40  isSoundRequired:YES timming:2.0 noOfLines:1];
//
...
//    //        float y_axis = self.view.frame.size.height - 120;
//    //
//    //        NSString * mesg = [NSString stringWithFormat:@"%@",NSLocalizedString(@"paid_amount_exceeding_the_total_cost",nil)];
//    //
//    //        [self displayAlertMessage:mesg horizontialAxis:(self.view.frame.size.width - 400)/2   verticalAxis:y_axis  msgType:@""  conentWidth:300 contentHeight:40  isSoundRequired:YES timming:2.0 noOfLines:1];
...
//            [HUD show: YES];
//            [HUD setHidden: NO];
//            [HUD setLabelText:NSLocalizedString(@"Updating Order...",nil)];
//
...
//
//            NSMutableDictionary * updateOrderDic = [[NSMutableDictionary alloc] init];
//
//            //Order Details...
//            updateOrderDic[REQUEST_HEADER] = [RequestHeader getRequestHeader];
//            updateOrderDic[Order_Date] = orderCreatedDateStr;
//            updateOrderDic[DELIVERY_DATE] = orderDeliveryDateStr;
//
//            updateOrderDic[PAYMENT_TYPE] = paymentTypeText.text;
//            updateOrderDic[PAYMENT_MODE] = paymentModeText.text;
//            updateOrderDic[SALE_LOCATION] = locationText.text;
//            updateOrderDic[EMAIL_ID] = customerEmailIdText.text;
//            updateOrderDic[MOBILE_NUM] = customerMobileNoText.text;
//            updateOrderDic[PAYMENT_REF] = paymentRefText.text;
//
//            //Customer Address..
//            updateOrderDic[CUSTOMER_ADDRESS_STREET] = streetText.text;
//            updateOrderDic[CUSTOMER_ADDRESS_LOCATION] = customerLocationText.text;
//            updateOrderDic[CUSTOMER_ADDRESS_CITY] = customerCityText.text;
//            updateOrderDic[CUSTOMER_ADDRESS_DOOR_NO] = doorNoText.text;
//            updateOrderDic[CUSTOMER_CONTACT_NUM] = contactNoText.text;
//            updateOrderDic[CUSTOMER_MAP_LINK] = googleMapLinkText.text;
//            updateOrderDic[customer_pinNo] = pinNoText.text;
//
//            //Billing Address...
//            updateOrderDic[BILLING_ADDRESS_STREET] = billingStreetText.text;
//            updateOrderDic[BILLING_ADDRESS_LOCATION] = billingLocationText.text;
//            updateOrderDic[BILLING_ADDRESS_CITY] = billingCityText.text;
//            updateOrderDic[BILLING_ADDRESS_DOOR_NO] = billingDoorNoText.text;
//            updateOrderDic[BILLING_CONTACT_NUM] = billingContactNoText.text;
//            updateOrderDic[BILLING_MAP_LINK] = billingGoogleMapLinkText.text;
//            updateOrderDic[billing_pinNo] = billingPinNoText.text;
//
//            //Shipment Address...
//            updateOrderDic[SHIPMENT_CONTACT_NUM] = shipmentContactNoText.text;
//            updateOrderDic[SHIPMENT_DOOR_NO] = shipmentDoorNoText.text;
//            updateOrderDic[SHIPMENT_STREET] = shipmentStreetNoText.text;
//            updateOrderDic[SHIPMENT_NAME] = shipmentNameText.text;
//            updateOrderDic[SHIPMENT_LOCATION] = shipmentLocationText.text;
//            updateOrderDic[SHIPMENT_CITY] = shipmentCityText.text;
//            updateOrderDic[SHIPMENT_STATE] = shipmentStateText.text;
//
//            //Other Details...
//
//            updateOrderDic[ORDER_CHANNEL] = orderChannelText.text;
//            updateOrderDic[SHIPPER_ID] = shipmentTypeText.text;
//            updateOrderDic[SALES_EXECUTIVE_ID] = salesExecutiveIdText.text;
//            updateOrderDic[SALES_EXECUTIVE_NAME] = salesExecutiveNameText.text;
//            //updateOrderDic[REFERRED_BY] = referredByText.text;
//            updateOrderDic[ORDER_DELIVERY_TYPE] = deliveryTypeText.text;
//            updateOrderDic[kShipmentMode] = shipmentModeText.text;
//
//            updateOrderDic[ORDER_ID] = orderId;
//
//            updateOrderDic[ORDER_STATUS] = nextActivitiesArray[0];
//
//            //Discount Level Calulations....
//            //Appending it Statically temporarly....
//            updateOrderDic[SPECIAL_DISCOUNT] = @0.0f;
//            updateOrderDic[OTHER_TAX_AMT] = @0.0f;
//            updateOrderDic[OTHER_DISCOUNTS] = otherDiscAmountTxt.text;
//            updateOrderDic[IS_GST_AMOUNT] = @0.0f;
//
//            updateOrderDic[SUB_TOTAL] = subTotalText.text;
//            updateOrderDic[ORDER_TOTAL_COST] = totalCostText.text;
//            updateOrderDic[TOTAL_ORDER_AMOUNT] = totalCostText.text;
//            updateOrderDic[ORDER_TAX] = totalTaxTxt.text;
//            updateOrderDic[BILL_DUE] = amountDueText.text;
//            updateOrderDic[PAID_AMT] = amountPaidText.text;
//            updateOrderDic[SHIPMENT_CHARGES] = shippingCostText.text;
//            updateOrderDic[no_of_items] = [NSNumber numberWithInteger:orderItemListArray.count];
//
//
//            // item Dictionary....
...
//
//            updateOrderDic[ORDER_DISCOUNTS_LIST] = orderDiscountsArr;
//            updateOrderDic[ORDER_ITEM_TAXES_LIST] = orderItemTaxesListArr;
//            updateOrderDic[ORDER_TRANSACTIONS] = orderTransactionArr;
//
//            updateOrderDic[kItemDetails] = orderItemListArray;
//            updateOrderDic[ORDERED_ITEMSLIST] = orderItemListArray;
//
//
//            NSError  * err;
//            NSData   * jsonData = [NSJSONSerialization dataWithJSONObject:updateOrderDic options:0 error:&err];
//
...
// Changed by roja on 16/4/2019
-(void)updateOrder:(UIButton*)sender {
    
    if ((customerEmailIdText.text).length > 0 && ([self validateEmail:customerEmailIdText.text] == FALSE)) {
    ...
    else if([confirmDateText.text length] == 0){
      
        float y_axis = self.view.frame.size.height/2;

        NSString * mesg = [NSString stringWithFormat:@"%@",NSLocalizedString(@"please_select_confirm_date_to_deliver_the_order",nil)];
        
        [self displayAlertMessage:mesg horizontialAxis:(self.view.frame.size.width - 400)/2   verticalAxis:y_axis  msgType:@""  conentWidth:400 contentHeight:50  isSoundRequired:YES timming:2.0 noOfLines:2];

        UIButton * confirmDate = [[UIButton alloc]init];
        confirmDate.tag = 6;
        [self showCalenderInPopUp:confirmDate];
    }
    else if([confirmStartTimeTF.text length] == 0){
        
        float y_axis = self.view.frame.size.height/2;

        NSString * mesg = [NSString stringWithFormat:@"%@",NSLocalizedString(@"please_select_start_time_to_deliver_the_order",nil)];
        
        [self displayAlertMessage:mesg horizontialAxis:(self.view.frame.size.width - 400)/2   verticalAxis:y_axis  msgType:@""  conentWidth:400 contentHeight:40  isSoundRequired:YES timming:2.0 noOfLines:2];
        
//        UIButton * startTimeBtn = [[UIButton alloc]init];
//        startTimeBtn.tag = 2;
//        [self showStartTime:startTimeBtn];
        
    }else if([confirmEndTimeTF.text length] == 0){
        
        float y_axis = self.view.frame.size.height/2;
        
        NSString * mesg = [NSString stringWithFormat:@"%@",NSLocalizedString(@"please_select_end_time_to_deliver_the_order",nil)];
        
        [self displayAlertMessage:mesg horizontialAxis:(self.view.frame.size.width - 400)/2   verticalAxis:y_axis  msgType:@""  conentWidth:400 contentHeight:40  isSoundRequired:YES timming:2.0 noOfLines:2];
        
//        UIButton * endTimeBtn = [[UIButton alloc]init];
//        endTimeBtn.tag = 4;
//        [self showStartTime:endTimeBtn];
    }
        ...
        [self displayAlertMessage:mesg horizontialAxis:(self.view.frame.size.width - 400)/2   verticalAxis:y_axis  msgType:@""  conentWidth:300 contentHeight:50  isSoundRequired:YES timming:2.0 noOfLines:2];
        [amountPaidText becomeFirstResponder];
    }
...
//            [updateStockDic valueForKey:STATUS];
            NSString * updateStatuStr = orderStatus;
            
            if ([updateStatuStr caseInsensitiveCompare:@"draft"] == NSOrderedSame ) {
                
                updateOrderDic[ORDER_STATUS] = CONFIRMED;

                if (sender.tag == 2) { // saveButton
                    updateOrderDic[ORDER_STATUS] = DRAFT;
                }
            }
            else {
                
                if (selectedStatusTag == 100) { // if not selected
                    updateOrderDic[ORDER_STATUS] = updateStatuStr;
                }
                else{
                    updateOrderDic[ORDER_STATUS] = nextActivitiesArray[selectedStatusTag];
                }
            }
            ...
            // added by roja on 16/04/2019.
            updateOrderDic[DELIVERY_SLOT_START_TIME] = deliveryStartTimeTF.text;
            updateOrderDic[DELIVERY_SLOT_END_TIME] = deliveryEndTimeTF.text;
            updateOrderDic[DELIVERY_MODEL] = deliveryModelTF.text;
            
            updateOrderDic[CONFIRMED_SLOT_END_TIME] = confirmEndTimeTF.text;
            updateOrderDic[CONFIRMED_SLOT_START_TIME] = confirmStartTimeTF.text;
            updateOrderDic[CONFIRMED_DATE] = confirmDateText.text;
    ...
    @try {
        ...
        if([[successDictionary allKeys] containsObject:kSkuLists] && ![[successDictionary valueForKey:kSkuLists] isKindOfClass:[NSNull class]]){
            ...
            if([[successDictionary valueForKey:kSkuLists] count] > 0){
                ...
                if(!isNewItem)
                    minimumQty = [[existingDic valueForKey:CONFIRM_QUANTITY] floatValue]; //ORDERED_QUANTITY
                ...
                if(showAlert){
                    ...
                    // commented by roja on 16/04/2019...
                    // may be used further
//                    [existingDic setValue: [NSString stringWithFormat:@"%.2f",minimumQty] forKey:ORDERED_QUANTITY];
                    [existingDic setValue:[self checkGivenValueIsNullOrNil:[existingDic valueForKey:ORDERED_QUANTITY] defaultReturn:@""] forKey:ORDERED_QUANTITY];
                    
                    // added by roja on 16/04/2019..
                    [existingDic setValue:[NSString stringWithFormat:@"%.2f", minimumQty] forKey:CONFIRM_QUANTITY];
                ...
                if (isNewItem) {
                    ...
                    [itemDetailsDic setValue:[NSNumber numberWithBool:[self checkGivenValueIsNullOrNil:[itemdic valueForKey:EDITABLE] defaultReturn:ZERO_CONSTANT]] forKey:EDITABLE];
                    ...
                    // added by roja on 16/04/2019..
                    [itemDetailsDic setValue:[NSString stringWithFormat:@"%.2f", minimumQty] forKey:CONFIRM_QUANTITY]; //[NSString stringWithFormat:@"%.2f", minimumQty]
                    
                    [itemDetailsDic setValue:[NSString stringWithFormat:@"%.2f",[[self checkGivenValueIsNullOrNil:[itemdic valueForKey:@"quantity"] defaultReturn:@"0"] floatValue]] forKey:AVAILABLE_QUANTITY];
...
-(void)getOutletOrderDetailsSuccessResponse:(NSDictionary *)successDictionary {
    ...
    @try {
        ...
        //Initializing the Next Activities Array....
        
        nextActivitiesArray = [NSMutableArray new];
        ...
        orderDateText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:Order_Date] defaultReturn:@""];
        
        deliveryDateText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:DELIVERY_DATE] defaultReturn:@""];
        
        // added by roja on 16/04/2019...
        deliveryStartTimeTF.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:DELIVERY_SLOT_START_TIME] defaultReturn:@""];
        
        deliveryEndTimeTF.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:DELIVERY_SLOT_END_TIME] defaultReturn:@""];

        confirmDateText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:CONFIRMED_DATE] defaultReturn:@""];
        
        confirmStartTimeTF.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:CONFIRMED_SLOT_START_TIME] defaultReturn:@""];
        
        confirmEndTimeTF.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:CONFIRMED_SLOT_END_TIME] defaultReturn:@""];
        
        deliveryModelTF.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:DELIVERY_MODEL] defaultReturn:@""];
        
        firstNameTF.text = [self checkGivenValueIsNullOrNil:[orderDic valueForKey:SHIPMENT_NAME] defaultReturn:@""];
        //        lastNameTF.text = [self checkGivenValueIsNullOrNil:[orderDic valueForKey:LAST_NAME] defaultReturn:@""];
        // Upto here added by roja on 16/04/2019...

        paymentTypeText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:PAYMENT_TYPE] defaultReturn:@""];
        
        paymentModeText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:PAYMENT_MODE] defaultReturn:@""];
        
        locationText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:SALE_LOCATION] defaultReturn:@""];
        
        customerEmailIdText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:EMAIL_ID] defaultReturn:@""];
        
        customerMobileNoText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:MOBILE_NUM] defaultReturn:@""];
        
        paymentRefText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:PAYMENT_REF] defaultReturn:@""];
        
        //Customer Address:
        streetText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:CUSTOMER_ADDRESS_STREET] defaultReturn:@""];
        
        customerLocationText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:CUSTOMER_ADDRESS_LOCATION] defaultReturn:@""];
        
        customerCityText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:CUSTOMER_ADDRESS_CITY] defaultReturn:@""];
        
        doorNoText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:CUSTOMER_ADDRESS_DOOR_NO] defaultReturn:@""];
        
        contactNoText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:MOBILE_NUM] defaultReturn:@""];// [orderDic  valueForKey:CUSTOMER_CONTACT_NUM]
        
        googleMapLinkText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:CUSTOMER_MAP_LINK] defaultReturn:@""];
        
        pinNoText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:customer_pinNo] defaultReturn:@""];
        
        //Billing Address:
        billingStreetText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:BILLING_ADDRESS_STREET] defaultReturn:@""];
        
        billingLocationText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:BILLING_ADDRESS_LOCATION] defaultReturn:@""];
        
        billingCityText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:BILLING_ADDRESS_CITY] defaultReturn:@""];
        
        billingDoorNoText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:BILLING_ADDRESS_DOOR_NO] defaultReturn:@""];
        
        billingContactNoText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:MOBILE_NUM] defaultReturn:@""];//[orderDic  valueForKey:BILLING_CONTACT_NUM]
        
        billingGoogleMapLinkText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:BILLING_MAP_LINK] defaultReturn:@""];
        
        billingPinNoText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:billing_pinNo] defaultReturn:@""];
        
        //Shipment Address:
        
        shipmentContactNoText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:SHIPMENT_CONTACT_NUM] defaultReturn:@""];
        
        shipmentDoorNoText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:SHIPMENT_DOOR_NO] defaultReturn:@""];
        
        shipmentStreetNoText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:SHIPMENT_STREET] defaultReturn:@""];
        
        shipmentNameText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:SHIPMENT_NAME] defaultReturn:@""];
        
        shipmentLocationText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:SHIPMENT_LOCATION] defaultReturn:@""];
        
        shipmentCityText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:SHIPMENT_CITY] defaultReturn:@""];
        
        shipmentStateText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:SHIPMENT_STATE] defaultReturn:@""];
        
        //Other Details....
        
        orderChannelText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:ORDER_CHANNEL] defaultReturn:@""];
        
        shipmentTypeText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:SHIPPER_ID] defaultReturn:@""];
        
        salesExecutiveIdText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:SALES_EXECUTIVE_ID] defaultReturn:@""];
        
        salesExecutiveNameText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:SALES_EXECUTIVE_NAME] defaultReturn:@""];
        
        // referredByText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:REFERRED_BY] defaultReturn:@""];
        
        deliveryTypeText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:ORDER_DELIVERY_TYPE] defaultReturn:@""];
        
        shipmentModeText.text = [self checkGivenValueIsNullOrNil:[orderDic  valueForKey:kShipmentMode] defaultReturn:@""];
        
        
        amountPaidText.text = [NSString stringWithFormat:@"%.2f",[[self checkGivenValueIsNullOrNil:[orderDic  valueForKey:PAID_AMT] defaultReturn:@"0.00"] floatValue]];
        
        shippingCostText.text = [NSString stringWithFormat:@"%.2f",[[self checkGivenValueIsNullOrNil:[orderDic  valueForKey:SHIPMENT_CHARGES] defaultReturn:@"0.00"] floatValue]];
        
        // Added by roja on 01-10-2018..
        
        otherDiscAmountTxt.text = [NSString stringWithFormat:@"%.2f",[[self checkGivenValueIsNullOrNil:[orderDic  valueForKey:OTHER_DISCOUNTS] defaultReturn:@"0.00"] floatValue]];
        
        otherDiscountText.text = [NSString stringWithFormat:@"%.2f",[[self checkGivenValueIsNullOrNil:[orderDic  valueForKey:OTHER_DISCOUNTS] defaultReturn:@"0.00"] floatValue]];
        
         orderStatus = [self checkGivenValueIsNullOrNil:[orderDic valueForKey:@"orderStatus"] defaultReturn:@""];


        // showing the next activities
        // commented by roja...
//        if([[orderDic valueForKey:NEXT_ACTIVITIES] count] || [[orderDic valueForKey:WORKFLOW_LIST] count]){
//
//            for(NSString * str in [orderDic valueForKey:NEXT_WORK_FLOW_STATES])// NEXT_ACTIVITIES
//                [nextActivitiesArray addObject:str];
//        }
        
        // added by roja on 03/03/2019...

        if([[orderDic valueForKey:NEXT_ACTIVITIES] count] ){
            
            for(NSString * str in [orderDic valueForKey:NEXT_ACTIVITIES])
                [nextActivitiesArray addObject:str];
        }
        else if([[orderDic valueForKey:NEXT_WORK_FLOW_STATES] count]){
            
            for(NSString * str in [orderDic valueForKey:NEXT_WORK_FLOW_STATES])
                [nextActivitiesArray addObject:str];
        }

        if ([[orderDic valueForKey:@"orderStatus"] caseInsensitiveCompare:@"Draft"] == NSOrderedSame) {
            ...
            if(nextActivitiesArray.count == 0){
                
                submitBtn.hidden = YES;
                saveBtn.hidden = YES;
                // frame for the UIbuttons...
                cancelBtn.frame = CGRectMake(searchItemsText.frame.origin.x, totalCostText.frame.origin.y, 115, 40);
            }
            else{
        ...
        [self populateButtons:nextActivitiesArray];
        
        //upto here.....
        
        //Reading the objects in itemLevel....
        
        float actualCartTotalAmt = 0.0;
        ...
        for (int i = 0; i < orderItems.count; i++) {
            ...
            for(NSDictionary *itemTaxDic in [orderDic valueForKey:ORDER_ITEM_TAXES_LIST]){
...
//            float itemTotalPrice = [[self checkGivenValueIsNullOrNil:[orderItemDic  valueForKey:Item_Price] defaultReturn:@"0.00"] floatValue] + [[self checkGivenValueIsNullOrNil:[orderItemDic  valueForKey:MANUAL_DISCOUNT] defaultReturn:@"0.00"] floatValue];
            ...
            // Discount details ....
            for(NSDictionary *discountDic in [orderDic valueForKey:ORDER_DISCOUNTS_LIST]){
...
//                    itemTotalPrice = itemTotalPrice + [[discountDic valueForKey:DISCOUNT_PRICE]floatValue];
            ...
            actualCartTotalAmt += ([[self checkGivenValueIsNullOrNil:[orderItemDic  valueForKey:SALE_PRICE] defaultReturn:@"0.00"]floatValue] * [[self checkGivenValueIsNullOrNil:[orderItemDic  valueForKey:CONFIRM_QUANTITY] defaultReturn:@"0.00"] floatValue]); //ORDERED_QUANTITY
...
//            [orderItemDetailsDic setValue:[NSString stringWithFormat:@"%.2f",itemTotalPrice] forKey:Item_Price];
            ...
            [orderItemDetailsDic setValue:[NSNumber numberWithBool:[[self checkGivenValueIsNullOrNil:[orderItemDic valueForKey:EDITABLE] defaultReturn:ZERO_CONSTANT] boolValue]] forKey:EDITABLE];
            ...
            [orderItemDetailsDic setValue:[NSString stringWithFormat:@"%.2f",[[self checkGivenValueIsNullOrNil:[orderItemDic  valueForKey:AVAILABLE_QUANTITY] defaultReturn:@"0.00"] floatValue]] forKey:AVAILABLE_QUANTITY];
...
//        otherDiscPercentageTxt.text = [NSString stringWithFormat:@"%.2f",(otherDiscAmountTxt.text.floatValue * 100)/(actualCartTotalAmt-discountAmt)];
...
-(void)updateOutletOrderErrorResponse:(NSString *)errorResponse {
    ...
    @try {
        ...
        [self displayAlertMessage:mesg horizontialAxis:(self.view.frame.size.width - 360)/2   verticalAxis:y_axis  msgType:@""  conentWidth:350 contentHeight:40  isSoundRequired:YES timming:2.0 noOfLines:1];
...
//
//                        //Customer Email ID...
//                        customerEmailIdText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_MAIL]defaultReturn:@""];
//
//                        //Customer Address
//                        streetText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_STREET]defaultReturn:@""];
//
//                        customerLocationText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_LOCALITY]defaultReturn:@""];
//
//                        customerCityText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_CITY]defaultReturn:@""];
//
//                        doorNoText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:HOUSE_NO]defaultReturn:@""];
//
//                        contactNoText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_PHONE]defaultReturn:@""];
//
//                        pinNoText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_PIN_NO]defaultReturn:@""];
//
//                        //Billing Address
//                        billingStreetText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_STREET]defaultReturn:@""];
//
//                        billingLocationText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_LOCALITY]defaultReturn:@""];
//
//                        billingCityText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_CITY]defaultReturn:@""];
//
//                        billingDoorNoText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:HOUSE_NO]defaultReturn:@""];
//
//                        billingContactNoText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_PHONE]defaultReturn:@""];
//
//                        billingPinNoText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_PIN_NO]defaultReturn:@""];
//
//                        //Shipment Address
//
//                        shipmentContactNoText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_PHONE]defaultReturn:@""];
//
//                        shipmentDoorNoText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:HOUSE_NO]defaultReturn:@""];
//
//                        shipmentStreetNoText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_STREET]defaultReturn:@""];
//
//                        shipmentNameText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:kFirstName]defaultReturn:@""];
//
//                        shipmentLocationText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_LOCALITY]defaultReturn:@""];
//
//                        shipmentCityText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:CUSTOMER_CITY]defaultReturn:@""];
//
//                        shipmentStateText.text = [self checkGivenValueIsNullOrNil:[customerInfoDic valueForKey:STATE]defaultReturn:@""];
//
...
- (void)showStartTime:(UIButton *)sender {
    ...
    @try {
        ...
        if(startTimedetailsArr == nil ||  startTimedetailsArr.count == 0){
            
            [self getRouteMasters];
        }
        
        if(startTimedetailsArr.count){
            
            float tableHeight = startTimedetailsArr.count * 35;
         
            if(startTimedetailsArr.count > 5)
                tableHeight = (tableHeight/startTimedetailsArr.count) * 5;
            
            [self showPopUpForTables:startTimeTable  popUpWidth:(confirmStartTimeTF.frame.size.width) + 15 popUpHeight:tableHeight presentPopUpAt:confirmStartTimeTF  showViewIn:createOrderScrollView permittedArrowDirections:UIPopoverArrowDirectionUp];
            [startTimeTable reloadData];
        }
        else
            [catPopOver dismissPopoverAnimated:YES];
...
-(void)populateButtons:(NSArray *)buttonsArr {
    ...
    @try {
        ...
        for (NSString * str in buttonsArr) {
            ...
            UIButton * workFlowButton    = [[UIButton alloc]init];
            workFlowButton.layer.cornerRadius = 3.0f;
            workFlowButton.backgroundColor = [UIColor grayColor];
            [workFlowButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            workFlowButton.tag = i;
            
            i++;
            
            [workFlowButton setTitle:[NSString stringWithFormat:@"%@",str] forState:UIControlStateNormal];
//            [workFlowButton addTarget:self action:@selector(updateOrder:) forControlEvents:UIControlEventTouchUpInside];
            [workFlowButton addTarget:self action:@selector(setButtonTag:) forControlEvents:UIControlEventTouchUpInside];
            workFlowButton.titleLabel.font = [UIFont fontWithName:TEXT_FONT_NAME size:18.0f];
            
            if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
                
                workFlowButton.frame = CGRectMake(xposition, 5, 106, 40);
                [buttonScrollView addSubview:workFlowButton];
            }
            xposition = xposition + workFlowButton.frame.size.width + 10;
            index++;
        }
...
-(void)setButtonTag:(UIButton *)sender{
    
   selectedStatusTag = (int)sender.tag;
    ...
    @try {
        ...
        if ([UIDevice currentDevice].userInterfaceIdiom == UIUserInterfaceIdiomPad) {
            ...
            if(sender.tag == 2)
                ...
                [popover presentPopoverFromRect:confirmDateText.frame inView:createOrderScrollView permittedArrowDirections:UIPopoverArrowDirectionUp animated:YES];
...
-(void)clearDate:(UIButton *)sender{
    ...
    @try {
        ...
        else{ // tag = 6 for confirm btn
            confirmDateText.text = @"";
        }
...
-(void)populateDateToTextField:(UIButton *)sender {
    ...
    @try {
        ...
        // added by roja on 16/04/2019
        else { // tag=6 confirm btn
            
            confirmDateText.text = dateString;
        }
 ...
 *
 * @modified BY  Roja on 24/09/2018
 * @reason       otherDiscPercentageTxt and otherDiscAmountTxt textField's added.
 *
 * @return
 * @return
 * @verified By
...
-(BOOL)textFieldShouldBeginEditing:(UITextField *)textField{
    ...
    if (textField.frame.origin.x == orderQuantityText.frame.origin.x || textField.frame.origin.x == itemSalePriceTxt.frame.origin.x ||( textField.frame.origin.x == confirmQtyText.frame.origin.x && textField.frame.origin.y ==  confirmQtyText.frame.origin.y)){
 ...
 *
 * @modified BY  Roja on 24/09/2018
 * @reason       added orderQuantityText and itemSalePriceTxt,otherDiscPercentageTxt & otherDiscAmountTxt..
 *
 * @return
 * @return
 * @verified By
...
-(void)textFieldDidBeginEditing:(UITextField*)textField {
    ...
    @try {
        ...
        else if (textField.frame.origin.x == orderQuantityText.frame.origin.x || textField.frame.origin.x == itemSalePriceTxt.frame.origin.x ||  (textField.frame.origin.x ==  confirmQtyText.frame.origin.x && textField.frame.origin.y ==  confirmQtyText.frame.origin.y) ) {
 ...
 * @modified BY  Srinivasulu on 17/01/2016
 * @reason       changed the comment's section....
 * @modified BY  Roja on 18/09/2018 && 16/04/2019
 * @reason       checking item "packed" flag in orderQuantityText field also Added shouldChangeCharactersInRange for
                 itemSalePriceTxt, shippingCostText, otherDiscAmountTxt,otherDiscPercentageTxt,customerMobileNoText and pinNoText .. added confirmQtyText
 *
 * @return
 * @verified By
 * @verified On
...
-(BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    if (textField.frame.origin.x == confirmQtyText.frame.origin.x  && textField.frame.origin.y == confirmQtyText.frame.origin.y) {
   ...
   else if (textField.frame.origin.x == orderQuantityText.frame.origin.x && textField.frame.origin.y == orderQuantityText.frame.origin.y) {
...
- (void)textFieldDidEndEditing:(UITextField *)textField {
    ...
    if(textField.frame.origin.x == confirmQtyText.frame.origin.x && textField.frame.origin.y == confirmQtyText.frame.origin.y) {
        ...
        @try{
            ...
            float confirmQty  = (textField.text).floatValue;
            
            if (confirmQty < [[locDic valueForKey:ORDERED_QUANTITY] floatValue] ) {
                ...
                else if ( ![[locDic valueForKey:ZERO_STOCK_FLAG] boolValue]) {
                    
                    if ( confirmQty > [[locDic valueForKey:AVAILABLE_QUANTITY] floatValue] ) { // or MAX_QUANTITY
                        
                        isValidQty = false;
                        
                        float y_axis = self.view.frame.size.height - 450;
                        NSString * mesg = [NSString stringWithFormat:@"%@",NSLocalizedString(@"confirm_quantity_should_not_exceed_the_available_quantity", nil)];
                        [self displayAlertMessage:mesg horizontialAxis:(self.view.frame.size.width - 360)/2   verticalAxis:y_axis  msgType:@""  conentWidth:300 contentHeight:45  isSoundRequired:YES timming:2.0 noOfLines:2];
                    }
                }
            }
                ...
                float y_axis = self.view.frame.size.height - 450;
                NSString * mesg = [NSString stringWithFormat:@"%@",NSLocalizedString(@"quantity_should_not_exceed_the_ordered_quantity", nil)];
                [self displayAlertMessage:mesg horizontialAxis:(self.view.frame.size.width - 360)/2   verticalAxis:y_axis  msgType:@""  conentWidth:300 contentHeight:45  isSoundRequired:YES timming:2.0 noOfLines:2];
            }
            ...
            if(isValidQty){
                ...
                amountPaidText.text = @"0.0";
                amountDueText.text = totalCostText.text;
                [locDic setValue:textField.text  forKey:CONFIRM_QUANTITY];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    else if(tableView == startTimeTable){
        
        return startTimedetailsArr.count;
    }
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *) indexPath {
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        ...
        else if (tableView == productListTable||tableView == paymentModeTable || tableView == paymentTypeTable || tableView == virtualStoreTable || tableView == orderChannelTable || tableView == shipmentTypeTable || tableView == deliveryTypeTable || tableView == shipmentModeTable || deliveryModelTable || startTimeTable) {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (tableView == productListTable) {
        ...
        @try {
            ...
            availableQtyValueLbl  = [[UILabel alloc] init];
            availableQtyValueLbl.backgroundColor = [UIColor clearColor];
            availableQtyValueLbl.layer.borderWidth = 0;
            availableQtyValueLbl.textAlignment = NSTextAlignmentCenter;
            availableQtyValueLbl.numberOfLines = 1;
            availableQtyValueLbl.lineBreakMode = NSLineBreakByWordWrapping;
            ...
            orderQuantityText.borderStyle = UITextBorderStyleNone;
            ...
            orderQuantityText.userInteractionEnabled = NO;
            ...
            confirmQtyText = [[UITextField alloc] init];
            confirmQtyText.clearButtonMode = UITextFieldViewModeWhileEditing;
            confirmQtyText.autocorrectionType = UITextAutocorrectionTypeNo;
            confirmQtyText.borderStyle = UITextBorderStyleRoundedRect;
            confirmQtyText.keyboardType = UIKeyboardTypeNumberPad;
            confirmQtyText.backgroundColor = [UIColor clearColor];
            confirmQtyText.textAlignment = NSTextAlignmentCenter;
            confirmQtyText.textColor = [UIColor blackColor];
            confirmQtyText.returnKeyType = UIReturnKeyDone;
            confirmQtyText.userInteractionEnabled = YES;
            confirmQtyText.layer.borderWidth = 2;
            confirmQtyText.tag = indexPath.row;
            confirmQtyText.delegate = self;
            [confirmQtyText addTarget:self action:@selector(textFieldDidChange:) forControlEvents:UIControlEventEditingChanged];
            ...
            availableQtyValueLbl.textColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];
            confirmQtyText.textColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];
            // upto here added by roja on 10-09-2018...
...
//            itemSalePriceTxt.layer.borderColor = [UIColor colorWithRed:72.0/255.0 green:72.0/255.0 blue:72.0/255.0 alpha:1.0].CGColor;
            ...
            confirmQtyText.layer.borderColor = [UIColor colorWithRed:72.0/255.0 green:72.0/255.0 blue:72.0/255.0 alpha:1.0].CGColor;
            ...
            [hlcell.contentView addSubview:availableQtyValueLbl];
            [hlcell.contentView addSubview:confirmQtyText];
            // upto here added by roja on 10-09-2018...
            ...
            if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
                ...
                availableQtyValueLbl.frame = CGRectMake(availableQtyLbl.frame.origin.x, 0, availableQtyLbl.frame.size.width, hlcell.frame.size.height);
                
                orderQuantityText.frame = CGRectMake(quantityLabel.frame.origin.x, 2, quantityLabel.frame.size.width, 36);
                
                confirmQtyText.frame = CGRectMake(confirmQtyLbl.frame.origin.x, 2, confirmQtyLbl.frame.size.width, 36);
            ...
            itemSnoLabel.text   = [NSString stringWithFormat:@"%i",(int)(indexPath.row + 1)];
            ...
            // added by roja on 16/04/2019...
            confirmQtyText.text  =  [NSString stringWithFormat:@"%.2f", [[self checkGivenValueIsNullOrNil:[localDictionary valueForKey:CONFIRM_QUANTITY] defaultReturn:@"0.0"] floatValue]];
            
            availableQtyValueLbl.text  =  [NSString stringWithFormat:@"%.2f", [[self checkGivenValueIsNullOrNil:[localDictionary valueForKey:AVAILABLE_QUANTITY] defaultReturn:@"0.0"] floatValue]];
            //upto here added by roja on 16/04/2019...
    ...
    else if(tableView == startTimeTable) { // added by roja on 16/04/2019...
        ...
        @try {
            ...
            hlcell.textLabel.text = [self checkGivenValueIsNullOrNil:[startTimedetailsArr[indexPath.row] valueForKey:@"startTime"] defaultReturn:@""];
            hlcell.textLabel.textColor = [UIColor blackColor];
            hlcell.selectionStyle = UITableViewCellSelectionStyleNone;
            hlcell.textLabel.font =  [UIFont fontWithName:TEXT_FONT_NAME size:16];
        } @catch (NSException *exception) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    @try {
        ...
        if (tableView == paymentModeTable) {
            ...
            NSDictionary * timeDetailsDic = startTimedetailsArr[indexPath.row];
            
            confirmStartTimeTF.text = [timeDetailsDic valueForKey:@"startTime"];
            confirmEndTimeTF.text = [timeDetailsDic valueForKey:@"endTime"];
        }
    ...
    @try {
        ...
        for(int i=0; i< [orderItemListArray count]; i++) {
            ...
            if (otherDiscPercentageValue > 0){
                ...
                itemDiscValue = (((([[orderItemListDic valueForKey:SALE_PRICE]floatValue] * [[orderItemListDic valueForKey:CONFIRM_QUANTITY] floatValue]) - dealOfferAmount) * otherDiscPercentageValue)/100); //ORDERED_QUANTITY
            ...
            float itemTotalPrice =  [[orderItemListDic valueForKey:SALE_PRICE] floatValue] * [[orderItemListDic valueForKey:CONFIRM_QUANTITY] floatValue] - (dealOfferAmount + [[orderItemListDic valueForKey:ITEM_SPECIAL_DISCOUNT] floatValue]); //ORDERED_QUANTITY
            
            [orderItemListDic setValue:[NSString stringWithFormat:@"%.2f",(itemTotalPrice / [[orderItemListDic valueForKey:CONFIRM_QUANTITY] floatValue])] forKey:SALE_PRICE_AFTER_DISCOUNT]; //ORDERED_QUANTITY
            ...
            if((discCalcOn.length > 0 && [discCalcOn caseInsensitiveCompare:ORIGINAL_PRICE] == NSOrderedSame)){
                ...
                itemTotalPrice =  ( [[orderItemListDic valueForKey:SALE_PRICE] floatValue] * [[orderItemListDic valueForKey:CONFIRM_QUANTITY] floatValue] ); //ORDERED_QUANTITY
            }
            ...
            [orderItemListDic setValue:[NSString stringWithFormat:@"%.2f",( [[orderItemListDic valueForKey:SALE_PRICE] floatValue] * [[orderItemListDic valueForKey:CONFIRM_QUANTITY] floatValue] ) ] forKey:ITEM_COST_BEFORE_OTHER_DISCOUNT];//ORDERED_QUANTITY
    ...
    @try{
        ...
        for (NSDictionary * taxdic in [itemDetailsDic valueForKey:TAX]) {
            ...
            if ([[taxdic valueForKey:TAX_TYPE] caseInsensitiveCompare:Percentage] == NSOrderedSame) {
                ...
                specifiedTaxValue = (taxRateValue * [[itemDetailsDic valueForKey:CONFIRM_QUANTITY]floatValue]); //ORDERED_QUANTITY
            }
    ...
    @try {
        ...
        if(isToCallApplyCampaigns){
            ...
            for (int i = 0; i < orderItemListArray.count; i++) {
                ...
                [qtyList addObject: [NSString stringWithFormat:@"%.2f",[[detailsDic valueForKey:CONFIRM_QUANTITY]floatValue] ] ];//ORDERED_QUANTITY
                [totalPriceList addObject: [NSString stringWithFormat:@"%.2f", [[detailsDic valueForKey:Item_Price] floatValue] * [[detailsDic valueForKey:CONFIRM_QUANTITY]floatValue]] ];//ORDERED_QUANTITY
...
-(void)getRouteMasters {
    ...
    @try {
        ...
        [tempDic setValue:[RequestHeader getRequestHeader] forKey:REQUEST_HEADER];
        [tempDic setValue:NEGATIVE_ONE forKey:START_INDEX];
        
        NSError * err_;
        NSData  * jsonData_ = [NSJSONSerialization dataWithJSONObject:tempDic options:0 error:&err_];
        NSString * storesjsonStr = [[NSString alloc] initWithData:jsonData_ encoding:NSUTF8StringEncoding];
        
        WebServiceController *webServiceController = [WebServiceController new];
        webServiceController.routingServiceDelegate = self;
        [webServiceController getRouteMasters:storesjsonStr];
...
- (void)getRouteMastersSuccessResponse:(NSDictionary *)successDictionary{
    ...
    @try {
        ...
        startTimedetailsArr = [[NSMutableArray alloc] init];

        NSArray * routeListArr = [[successDictionary valueForKey:@"routeMasterList"] valueForKey:@"routeList"];
        
        
        for (NSDictionary * routeListDic in [routeListArr objectAtIndex:0] ) {
            ...
            if (![[routeListDic valueForKey:@"endTime"] isKindOfClass:[NSNull class]] && [routeListDic valueForKey:@"endTime"] != nil) {
                
                endTimeString = [NSString stringWithFormat:@"%@",[routeListDic valueForKey:@"endTime"]];//Jan 1, 1970 2:00:00 PM
                
                NSMutableArray * timeArr = [[NSMutableArray alloc] init];
                
                [timeArr addObject:[[endTimeString componentsSeparatedByString:@", "][1]  componentsSeparatedByString:@" "][1]]; //ex: 2:00:00
                [timeArr addObject:[[endTimeString componentsSeparatedByString:@", "][1]  componentsSeparatedByString:@" "][2]]; // ex: PM/AM

                endTimeString = [timeArr objectAtIndex:0];
                endTimeString = [[[endTimeString componentsSeparatedByString:@":"][0] stringByAppendingString:@":"] stringByAppendingString:[endTimeString componentsSeparatedByString:@":"][1]]; // ex:2:00
                
                endTimeString = [endTimeString stringByAppendingString:[timeArr objectAtIndex:1]]; //ex:2:00PM
                
                                                // OR... with out using array..
                //               endTimeString = [[[endTimeString componentsSeparatedByString:@", "][1]  componentsSeparatedByString:@" "][1] stringByAppendingString:[[endTimeString componentsSeparatedByString:@", "][1]  componentsSeparatedByString:@" "][2]]; //ex:2:00:00PM
                
            }
            if (![[routeListDic valueForKey:@"startTime"] isKindOfClass:[NSNull class]] && [routeListDic valueForKey:@"startTime"] != nil) {
                
                startTimeString = [NSString stringWithFormat:@"%@",[routeListDic valueForKey:@"startTime"]];
                
                NSMutableArray * timeArr = [[NSMutableArray alloc] init];
                
                [timeArr addObject:[[startTimeString componentsSeparatedByString:@", "][1]  componentsSeparatedByString:@" "][1]]; //ex: 2:00:00
                [timeArr addObject:[[startTimeString componentsSeparatedByString:@", "][1]  componentsSeparatedByString:@" "][2]]; // ex: PM/AM
                
                startTimeString = [timeArr objectAtIndex:0];
                startTimeString = [[[startTimeString componentsSeparatedByString:@":"][0] stringByAppendingString:@":"] stringByAppendingString:[startTimeString componentsSeparatedByString:@":"][1]]; // ex:2:00
                
                startTimeString = [startTimeString stringByAppendingString:[timeArr objectAtIndex:1]]; //ex:2:00PM
            }
            [tempDic setValue:endTimeString forKey:@"endTime"];
            [tempDic setValue:startTimeString forKey:@"startTime"];
            
            [startTimedetailsArr addObject: tempDic];
        }
