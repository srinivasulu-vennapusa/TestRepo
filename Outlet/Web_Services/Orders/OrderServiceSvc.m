...
@implementation OrderServiceSvc_cancelOrder
- (id)init
{
    if((self = [super init])) {
        orderDetails = 0;
...
- (void)addElementsToNode:(xmlNodePtr)node
{
    ...
    if(self.orderDetails != 0) {
        xmlAddChild(node, [self.orderDetails xmlNodeForDoc:node->doc elementName:@"orderDetails" elementNSPrefix:@"OrderServiceSvc"]);
    }
}
/* elements */
...
{
    OrderServiceSvc_cancelOrder *newObject = [OrderServiceSvc_cancelOrder new];
...
@end
@implementation OrderServiceSvc_cancelOrderResponse
- (id)init
{
    if((self = [super init])) {
        return_ = 0;
...
- (void)addElementsToNode:(xmlNodePtr)node
{
    ...
    if(self.return_ != 0) {
        xmlAddChild(node, [self.return_ xmlNodeForDoc:node->doc elementName:@"return" elementNSPrefix:@"OrderServiceSvc"]);
    }
}
/* elements */
@synthesize return_;
...
{
    OrderServiceSvc_cancelOrderResponse *newObject = [OrderServiceSvc_cancelOrderResponse new];
...
{
    OrderServiceSvc_createOrder *newObject = [OrderServiceSvc_createOrder new];
...
{
    OrderServiceSvc_createOrderResponse *newObject = [OrderServiceSvc_createOrderResponse new];
...
@end
@implementation OrderServiceSvc_getCustomerOrders
- (id)init
{
    if((self = [super init])) {
        customerDetails = 0;
...
- (void)addElementsToNode:(xmlNodePtr)node
{
    ...
    if(self.customerDetails != 0) {
        xmlAddChild(node, [self.customerDetails xmlNodeForDoc:node->doc elementName:@"customerDetails" elementNSPrefix:@"OrderServiceSvc"]);
    }
}
/* elements */
...
{
    OrderServiceSvc_getCustomerOrders *newObject = [OrderServiceSvc_getCustomerOrders new];
...
- (void)deserializeElementsFromNode:(xmlNodePtr)cur
{
    ...
    for( cur = cur->children ; cur != NULL ; cur = cur->next ) {
        if(cur->type == XML_ELEMENT_NODE) {
            ...
            if(xmlStrEqual(cur->name, (const xmlChar *) "customerDetails")) {
                ...
                self.customerDetails = newChild;
            }
        }
    }
}
@end
@implementation OrderServiceSvc_getCustomerOrdersResponse
- (id)init
{
    if((self = [super init])) {
        return_ = 0;
...
{
    OrderServiceSvc_getCustomerOrdersResponse *newObject = [OrderServiceSvc_getCustomerOrdersResponse new];
...
@end
@implementation OrderServiceSvc_getOrderDetails
- (id)init
{
    if((self = [super init])) {
        orderDetails = 0;
...
{
    OrderServiceSvc_getOrderDetails *newObject = [OrderServiceSvc_getOrderDetails new];
...
@end
@implementation OrderServiceSvc_getOrderDetailsResponse
- (id)init
{
    if((self = [super init])) {
        return_ = 0;
...
{
    OrderServiceSvc_getOrderDetailsResponse *newObject = [OrderServiceSvc_getOrderDetailsResponse new];
...
@end
@implementation OrderServiceSvc_getOrders
- (id)init
{
    if((self = [super init])) {
        orderDetails = 0;
...
{
    OrderServiceSvc_getOrders *newObject = [OrderServiceSvc_getOrders new];
...
@end
@implementation OrderServiceSvc_getOrdersResponse
- (id)init
{
    if((self = [super init])) {
        return_ = 0;
...
{
    OrderServiceSvc_getOrdersResponse *newObject = [OrderServiceSvc_getOrdersResponse new];
...
@end
@implementation OrderServiceSvc_getOrdersSummary
- (id)init
{
    if((self = [super init])) {
        customerDetails = 0;
...
{
    OrderServiceSvc_getOrdersSummary *newObject = [OrderServiceSvc_getOrdersSummary new];
...
@end
@implementation OrderServiceSvc_getOrdersSummaryResponse
- (id)init
{
    if((self = [super init])) {
        return_ = 0;
...
{
    OrderServiceSvc_getOrdersSummaryResponse *newObject = [OrderServiceSvc_getOrdersSummaryResponse new];
...
@end
@implementation OrderServiceSvc_searchOrders
- (id)init
{
    if((self = [super init])) {
        searchCriteria = 0;
...
{
    OrderServiceSvc_searchOrders *newObject = [OrderServiceSvc_searchOrders new];
...
@end
@implementation OrderServiceSvc_searchOrdersResponse
- (id)init
{
    if((self = [super init])) {
        return_ = 0;
...
{
    OrderServiceSvc_searchOrdersResponse *newObject = [OrderServiceSvc_searchOrdersResponse new];
...
@end
@implementation OrderServiceSvc_updateOrder
- (id)init
{
    if((self = [super init])) {
        orderDetails = 0;
...
{
    OrderServiceSvc_updateOrder *newObject = [OrderServiceSvc_updateOrder new];
...
@end
@implementation OrderServiceSvc_updateOrderResponse
- (id)init
{
    if((self = [super init])) {
        return_ = 0;
...
{
    OrderServiceSvc_updateOrderResponse *newObject = [OrderServiceSvc_updateOrderResponse new];
...
+ (void)initialize
{
    ...
    ([USGlobals sharedInstance].wsdlStandardNamespaces)[@"www.technolabssoftware.com"] = @"OrderServiceSvc";
}
+ (OrderServiceSoapBinding *)OrderServiceSoapBinding
{
//    return [[[OrderServiceSoapBinding alloc] initWithAddress:@"http://10.10.0.90/OmniRetailerServices/OrdersServices"] autorelease];
    NSString * url = [NSString stringWithFormat:@"%@%@",[WebServiceUtility getServiceURL],@"OrdersServices"];
    return [[OrderServiceSoapBinding alloc] initWithAddress:url] ;
}
@end
...
{
    return [self performSynchronousOperation:[(OrderServiceSoapBinding_updateOrder*)[OrderServiceSoapBinding_updateOrder alloc] initWithBinding:self delegate:self
...
{
    [self performAsynchronousOperation: [(OrderServiceSoapBinding_updateOrder*)[OrderServiceSoapBinding_updateOrder alloc] initWithBinding:self delegate:responseDelegate
                                                                                             parameters:aParameters
                                                                                             ]];
}
- (OrderServiceSoapBindingResponse *)searchOrdersUsingParameters:(OrderServiceSvc_searchOrders *)aParameters 
{
    return [self performSynchronousOperation:[(OrderServiceSoapBinding_searchOrders*)[OrderServiceSoapBinding_searchOrders alloc] initWithBinding:self delegate:self
                                                                                            parameters:aParameters
                                                                                            ]];
}
...
{
    [self performAsynchronousOperation: [(OrderServiceSoapBinding_searchOrders*)[OrderServiceSoapBinding_searchOrders alloc] initWithBinding:self delegate:responseDelegate
                                                                                             parameters:aParameters
                                                                                             ]];
}
- (OrderServiceSoapBindingResponse *)getOrdersUsingParameters:(OrderServiceSvc_getOrders *)aParameters 
{
    return [self performSynchronousOperation:[(OrderServiceSoapBinding_getOrders*)[OrderServiceSoapBinding_getOrders alloc] initWithBinding:self delegate:self
                                                                                            parameters:aParameters
                                                                                            ]];
}
...
{
    [self performAsynchronousOperation: [(OrderServiceSoapBinding_getOrders*)[OrderServiceSoapBinding_getOrders alloc] initWithBinding:self delegate:responseDelegate
                                                                                             parameters:aParameters
                                                                                             ]];
}
...
{
    return [self performSynchronousOperation:[(OrderServiceSoapBinding_getCustomerOrders*)[OrderServiceSoapBinding_getCustomerOrders alloc] initWithBinding:self delegate:self
                                                                                            parameters:aParameters
                                                                                            ]];
}
...
{
    [self performAsynchronousOperation: [(OrderServiceSoapBinding_getCustomerOrders*)[OrderServiceSoapBinding_getCustomerOrders alloc] initWithBinding:self delegate:responseDelegate
                                                                                             parameters:aParameters
                                                                                             ] ];
}
- (OrderServiceSoapBindingResponse *)getOrdersSummaryUsingParameters:(OrderServiceSvc_getOrdersSummary *)aParameters 
{
    return [self performSynchronousOperation:[(OrderServiceSoapBinding_getOrdersSummary*)[OrderServiceSoapBinding_getOrdersSummary alloc] initWithBinding:self delegate:self
                                                                                            parameters:aParameters
                                                                                            ]];
}
...
{
    [self performAsynchronousOperation: [(OrderServiceSoapBinding_getOrdersSummary*)[OrderServiceSoapBinding_getOrdersSummary alloc] initWithBinding:self delegate:responseDelegate
                                                                                             parameters:aParameters
                                                                                             ]];
}
- (OrderServiceSoapBindingResponse *)cancelOrderUsingParameters:(OrderServiceSvc_cancelOrder *)aParameters 
{
    return [self performSynchronousOperation:[(OrderServiceSoapBinding_cancelOrder*)[OrderServiceSoapBinding_cancelOrder alloc] initWithBinding:self delegate:self
                                                                                            parameters:aParameters
                                                                                            ] ];
}
...
{
    [self performAsynchronousOperation: [(OrderServiceSoapBinding_cancelOrder*)[OrderServiceSoapBinding_cancelOrder alloc] initWithBinding:self delegate:responseDelegate
                                                                                             parameters:aParameters
                                                                                             ] ];
}
...
@end
@implementation OrderServiceSoapBinding_updateOrder
...
- (void)main
{
    ...
    if(parameters != nil) bodyElements[@"updateOrder"] = parameters;
                        ...
                        for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
                            if(cur->type == XML_ELEMENT_NODE) {
                                if(xmlStrEqual(bodyNode->name, (const xmlChar *) "updateOrderResponse")) {
                                    OrderServiceSvc_updateOrderResponse *bodyObject = [OrderServiceSvc_updateOrderResponse deserializeNode:bodyNode];
...
@end
@implementation OrderServiceSoapBinding_searchOrders
@synthesize parameters;
- (id)initWithBinding:(OrderServiceSoapBinding *)aBinding delegate:(id<OrderServiceSoapBindingResponseDelegate>)responseDelegate
...
- (void)main
{
    ...
    NSMutableDictionary *bodyElements = nil;
    bodyElements = [NSMutableDictionary dictionary];
    if(parameters != nil) bodyElements[@"searchOrders"] = parameters;
            ...
            for( ; cur != NULL ; cur = cur->next) {
                if(cur->type == XML_ELEMENT_NODE) {
                    ...
                    if(xmlStrEqual(cur->name, (const xmlChar *) "Body")) {
                        ...
                        for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
                            if(cur->type == XML_ELEMENT_NODE) {
                                if(xmlStrEqual(bodyNode->name, (const xmlChar *) "searchOrdersResponse")) {
                                    OrderServiceSvc_searchOrdersResponse *bodyObject = [OrderServiceSvc_searchOrdersResponse deserializeNode:bodyNode];
                                    //NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
                                    if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
                                }
                                if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) && 
...
@end
@implementation OrderServiceSoapBinding_getOrders
@synthesize parameters;
- (id)initWithBinding:(OrderServiceSoapBinding *)aBinding delegate:(id<OrderServiceSoapBindingResponseDelegate>)responseDelegate
...
- (void)main
{
    ...
    NSMutableDictionary *bodyElements = nil;
    bodyElements = [NSMutableDictionary dictionary];
    if(parameters != nil) bodyElements[@"getOrders"] = parameters;
    
    NSString *operationXMLString = [envelope serializedFormUsingHeaderElements:headerElements bodyElements:bodyElements];
    
    //added by Srinivasulu on 14/02/2018....
    
    operationXMLString = [operationXMLString stringByReplacingOccurrencesOfString:@"OrderServiceSvc:orderDetails" withString:@"orderDetails"];
    operationXMLString = [operationXMLString stringByReplacingOccurrencesOfString:@"&amp;quot;" withString:@"\""];
    
    //upto here on 14/02/2018....
                        ...
                        for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
                            if(cur->type == XML_ELEMENT_NODE) {
                                if(xmlStrEqual(bodyNode->name, (const xmlChar *) "getOrdersResponse")) {
                                    OrderServiceSvc_getOrdersResponse *bodyObject = [OrderServiceSvc_getOrdersResponse deserializeNode:bodyNode];
                                    //NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
                                    if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
                                }
                                if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) && 
...
- (void)main
{
    ...
    NSMutableDictionary *bodyElements = nil;
    bodyElements = [NSMutableDictionary dictionary];
    if(parameters != nil) bodyElements[@"getOrderDetails"] = parameters;
                        ...
                        for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
                            if(cur->type == XML_ELEMENT_NODE) {
                                if(xmlStrEqual(bodyNode->name, (const xmlChar *) "getOrderDetailsResponse")) {
                                    OrderServiceSvc_getOrderDetailsResponse *bodyObject = [OrderServiceSvc_getOrderDetailsResponse deserializeNode:bodyNode];
                                    //NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
                                    if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
                                }
                                if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) && 
...
- (void)main
{
    ...
    NSMutableDictionary *bodyElements = nil;
    bodyElements = [NSMutableDictionary dictionary];
    if(parameters != nil) bodyElements[@"createOrder"] = parameters;
...
@end
@implementation OrderServiceSoapBinding_getCustomerOrders
@synthesize parameters;
- (id)initWithBinding:(OrderServiceSoapBinding *)aBinding delegate:(id<OrderServiceSoapBindingResponseDelegate>)responseDelegate
...
- (void)main
{
    ...
    NSMutableDictionary *bodyElements = nil;
    bodyElements = [NSMutableDictionary dictionary];
    if(parameters != nil) bodyElements[@"getCustomerOrders"] = parameters;
            ...
            for( ; cur != NULL ; cur = cur->next) {
                if(cur->type == XML_ELEMENT_NODE) {
                    ...
                    if(xmlStrEqual(cur->name, (const xmlChar *) "Body")) {
                        ...
                        for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
                            if(cur->type == XML_ELEMENT_NODE) {
                                if(xmlStrEqual(bodyNode->name, (const xmlChar *) "getCustomerOrdersResponse")) {
                                    OrderServiceSvc_getCustomerOrdersResponse *bodyObject = [OrderServiceSvc_getCustomerOrdersResponse deserializeNode:bodyNode];
                                    //NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
                                    if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
                                }
                                if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) && 
...
@end
@implementation OrderServiceSoapBinding_getOrdersSummary
@synthesize parameters;
- (id)initWithBinding:(OrderServiceSoapBinding *)aBinding delegate:(id<OrderServiceSoapBindingResponseDelegate>)responseDelegate
...
- (void)main
{
    ...
    NSMutableDictionary *bodyElements = nil;
    bodyElements = [NSMutableDictionary dictionary];
    if(parameters != nil) bodyElements[@"getOrdersSummary"] = parameters;
            ...
            for( ; cur != NULL ; cur = cur->next) {
                if(cur->type == XML_ELEMENT_NODE) {
                    ...
                    if(xmlStrEqual(cur->name, (const xmlChar *) "Body")) {
                        ...
                        for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
                            if(cur->type == XML_ELEMENT_NODE) {
                                if(xmlStrEqual(bodyNode->name, (const xmlChar *) "getOrdersSummaryResponse")) {
                                    OrderServiceSvc_getOrdersSummaryResponse *bodyObject = [OrderServiceSvc_getOrdersSummaryResponse deserializeNode:bodyNode];
                                    //NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
                                    if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
                                }
                                if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) && 
...
@end
@implementation OrderServiceSoapBinding_cancelOrder
@synthesize parameters;
- (id)initWithBinding:(OrderServiceSoapBinding *)aBinding delegate:(id<OrderServiceSoapBindingResponseDelegate>)responseDelegate
...
- (void)main
{
    ...
    NSMutableDictionary *bodyElements = nil;
    bodyElements = [NSMutableDictionary dictionary];
    if(parameters != nil) bodyElements[@"cancelOrder"] = parameters;
            ...
            for( ; cur != NULL ; cur = cur->next) {
                if(cur->type == XML_ELEMENT_NODE) {
                    ...
                    if(xmlStrEqual(cur->name, (const xmlChar *) "Body")) {
                        ...
                        for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
                            if(cur->type == XML_ELEMENT_NODE) {
                                if(xmlStrEqual(bodyNode->name, (const xmlChar *) "cancelOrderResponse")) {
                                    OrderServiceSvc_cancelOrderResponse *bodyObject = [OrderServiceSvc_cancelOrderResponse deserializeNode:bodyNode];
                                    //NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
                                    if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
                                }
                                if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) && 
...
- (NSString *)serializedFormUsingHeaderElements:(NSDictionary *)headerElements bodyElements:(NSDictionary *)bodyElements
{
    ...
    xmlNewNs(root, (const xmlChar*)"www.technolabssoftware.com", (const xmlChar*)"OrderServiceSvc");
