...
#endif
@implementation GiftVoucherServicesSvc_createGiftVouchers
- (id)init
{
	if((self = [super init])) {
...
- (void)dealloc
{
	if(giftVoucherDetails != nil) [giftVoucherDetails release];
	
	[super dealloc];
}
- (NSString *)nsPrefix
{
	return @"GiftVoucherServicesSvc";
}
- (xmlNodePtr)xmlNodeForDoc:(xmlDocPtr)doc elementName:(NSString *)elName elementNSPrefix:(NSString *)elNSPrefix
{
	...
	{
		nodeName = [NSString stringWithFormat:@"%@:%@", @"GiftVoucherServicesSvc", elName];
	}
...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.giftVoucherDetails != 0) {
		xmlAddChild(node, [self.giftVoucherDetails xmlNodeForDoc:node->doc elementName:@"giftVoucherDetails" elementNSPrefix:@"GiftVoucherServicesSvc"]);
	}
}
/* elements */
...
{
	GiftVoucherServicesSvc_createGiftVouchers *newObject = [[GiftVoucherServicesSvc_createGiftVouchers new] autorelease];
...
@end
@implementation GiftVoucherServicesSvc_createGiftVouchersResponse
- (id)init
{
	if((self = [super init])) {
		return_ = 0;
...
- (void)addElementsToNode:(xmlNodePtr)node
{
	...
	if(self.return_ != 0) {
		xmlAddChild(node, [self.return_ xmlNodeForDoc:node->doc elementName:@"return" elementNSPrefix:@"GiftVoucherServicesSvc"]);
	}
}
/* elements */
@synthesize return_;
...
{
	GiftVoucherServicesSvc_createGiftVouchersResponse *newObject = [[GiftVoucherServicesSvc_createGiftVouchersResponse new] autorelease];
...
@end
@implementation GiftVoucherServicesSvc_getGiftVoucherDetails
- (id)init
{
	if((self = [super init])) {
		giftVoucherDetails = 0;
...
{
	GiftVoucherServicesSvc_getGiftVoucherDetails *newObject = [[GiftVoucherServicesSvc_getGiftVoucherDetails new] autorelease];
...
@end
@implementation GiftVoucherServicesSvc_getGiftVoucherDetailsResponse
- (id)init
{
	if((self = [super init])) {
		return_ = 0;
...
{
	GiftVoucherServicesSvc_getGiftVoucherDetailsResponse *newObject = [[GiftVoucherServicesSvc_getGiftVoucherDetailsResponse new] autorelease];
...
@end
@implementation GiftVoucherServicesSvc_getGiftVouchers
- (id)init
{
	if((self = [super init])) {
		giftVoucherDetails = 0;
...
{
	GiftVoucherServicesSvc_getGiftVouchers *newObject = [[GiftVoucherServicesSvc_getGiftVouchers new] autorelease];
...
@end
@implementation GiftVoucherServicesSvc_getGiftVouchersResponse
- (id)init
{
	if((self = [super init])) {
		return_ = 0;
...
{
	GiftVoucherServicesSvc_getGiftVouchersResponse *newObject = [[GiftVoucherServicesSvc_getGiftVouchersResponse new] autorelease];
...
@end
@implementation GiftVoucherServicesSvc
+ (void)initialize
{
	[[USGlobals sharedInstance].wsdlStandardNamespaces setObject:@"xs" forKey:@"http://www.w3.org/2001/XMLSchema"];
	[[USGlobals sharedInstance].wsdlStandardNamespaces setObject:@"GiftVoucherServicesSvc" forKey:@"www.technolabssoftware.com"];
}
+ (GiftVoucherServicesSoapBinding *)GiftVoucherServicesSoapBinding
{
//	return [[[GiftVoucherServicesSoapBinding alloc] initWithAddress:@"http://10.10.0.17:9999/OmniRetailerServices/GiftVoucherServices"] autorelease];
    NSString *url = [NSString stringWithFormat:@"%@%@",[WebServiceUtility getServiceURL],@"GiftVoucherServices"];
    return [[[GiftVoucherServicesSoapBinding alloc] initWithAddress:url] autorelease];
}
@end
...
- (void)main
{
	...
	if(parameters != nil) [bodyElements setObject:parameters forKey:@"createGiftVouchers"];
						...
						for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
							if(cur->type == XML_ELEMENT_NODE) {
								if(xmlStrEqual(bodyNode->name, (const xmlChar *) "createGiftVouchersResponse")) {
									GiftVoucherServicesSvc_createGiftVouchersResponse *bodyObject = [GiftVoucherServicesSvc_createGiftVouchersResponse deserializeNode:bodyNode];
...
- (void)main
{
	...
	NSMutableDictionary *bodyElements = nil;
	bodyElements = [NSMutableDictionary dictionary];
	if(parameters != nil) [bodyElements setObject:parameters forKey:@"getGiftVoucherDetails"];
	
	NSString *operationXMLString = [envelope serializedFormUsingHeaderElements:headerElements bodyElements:bodyElements];
    operationXMLString = [operationXMLString stringByReplacingOccurrencesOfString:@"GiftVoucherServicesSvc:giftVoucherDetails" withString:@"giftVoucherDetails"];
						...
						for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
							if(cur->type == XML_ELEMENT_NODE) {
								if(xmlStrEqual(bodyNode->name, (const xmlChar *) "getGiftVoucherDetailsResponse")) {
									GiftVoucherServicesSvc_getGiftVoucherDetailsResponse *bodyObject = [GiftVoucherServicesSvc_getGiftVoucherDetailsResponse deserializeNode:bodyNode];
									//NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
									if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
								}
								if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) && 
...
- (void)main
{
	...
	NSMutableDictionary *bodyElements = nil;
	bodyElements = [NSMutableDictionary dictionary];
	if(parameters != nil) [bodyElements setObject:parameters forKey:@"getGiftVouchers"];
						...
						for(bodyNode=cur->children ; bodyNode != NULL ; bodyNode = bodyNode->next) {
							if(cur->type == XML_ELEMENT_NODE) {
								if(xmlStrEqual(bodyNode->name, (const xmlChar *) "getGiftVouchersResponse")) {
									GiftVoucherServicesSvc_getGiftVouchersResponse *bodyObject = [GiftVoucherServicesSvc_getGiftVouchersResponse deserializeNode:bodyNode];
									//NSAssert1(bodyObject != nil, @"Errors while parsing body %s", bodyNode->name);
									if (bodyObject != nil) [responseBodyParts addObject:bodyObject];
								}
								if (xmlStrEqual(bodyNode->ns->prefix, cur->ns->prefix) && 
...
- (NSString *)serializedFormUsingHeaderElements:(NSDictionary *)headerElements bodyElements:(NSDictionary *)bodyElements
{
	...
	xmlNewNs(root, (const xmlChar*)"www.technolabssoftware.com", (const xmlChar*)"GiftVoucherServicesSvc");
