...
@interface ViewGiftCoupon : CustomNavigationController<UITextFieldDelegate, MBProgressHUDDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate, UITableViewDataSource, UITableViewDelegate, GiftCouponServicesDelegate> {
